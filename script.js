const translations = {
    en: {
        ...
        "project-2-feature-4": "Firestore integration (optional)",
        "project-2-feature-5": "Responsive design",
        "project-2-tech": "<strong>Technologies:</strong> JavaScript, HTML, CSS, Local Storage, (Optional) Firebase Firestore",
        "project-2-demo": "View Demo",
        "project-3-title": "VR Training Application",
        "project-3-desc": "Built immersive VR features including...",
        "project-3-modal-title": "VR Training Application (Visionary Tool)",
        "project-3-modal-desc": "Developed interactive VR features for a training application, focusing on user tutorials, animations, and UI systems. Created an immersive experience for users to learn and practice various tasks.",
        "project-3-feature-1": "Interactive VR tutorials",
        "project-3-feature-2": "Custom animations and UI elements",
        "project-3-feature-3": "User-friendly interface design",
        "project-3-feature-4": "Optimized for performance in VR",
        "project-3-tech": "<strong>Technologies:</strong> Unity, C#, VR Development",
        "project-3-video": "Watch Demo Video",
        "project-4-title": "PC Game Launcher",
        "project-4-desc": "Revamped the launcher interface for...",
        "project-4-modal-title": "PC Game Launcher (Visionary Tool)",
        "project-4-modal-desc": "Revamped the user interface of a PC game launcher, improving its accessibility and overall user experience.  Focused on creating a modern, visually appealing design with clear navigation.",
        "project-4-feature-1": "Modernized UI design",
        "project-4-feature-2": "Improved navigation and layout",
        "project-4-feature-3": "Enhanced accessibility features",
        "project-4-feature-4": "User experience optimization",
        "project-4-tech": "<strong>Technologies:</strong> Unity, C#, UI/UX Design",
        "project-4-screenshots": "View Screenshots",
        "project-5-title": "Mobile Game Save System",
        "project-5-desc": "Implemented Firebase for secure data...",
        "project-5-modal-title": "Mobile Game Save System (FunTech Rocket)",
        "project-5-modal-desc": "Implemented a robust save system for a mobile game using Firebase.  This ensured secure data persistence and allowed users to save their progress across multiple devices.",
        "project-5-feature-1": "Firebase integration for data persistence",
        "project-5-feature-2": "Secure data storage and retrieval",
        "project-5-feature-3": "Cross-device synchronization",
        "project-5-feature-4": "Error handling and data validation",
        "project-5-tech": "<strong>Technologies:</strong> Unity, C#, Firebase Realtime Database",
        "project-5-play": "Play Game (Link to App Store)",
    ...
    es: {
        ...
        "project-2-feature-4": "Integración con Firestore (opcional)",
        "project-2-feature-5": "Diseño responsivo",
        "project-2-tech": "<strong>Tecnologías:</strong> JavaScript, HTML, CSS, Almacenamiento Local, (Opcional) Firebase Firestore",
        "project-2-demo": "Ver Demo",
        "project-3-title": "Aplicación de Entrenamiento VR",
        "project-3-desc": "Construí características VR inmersivas incluyendo...",
        "project-3-modal-title": "Aplicación de Entrenamiento VR (Visionary Tool)",
        "project-3-modal-desc": "Desarrollé características VR interactivas para una aplicación de entrenamiento, enfocándome en tutoriales para usuarios, animaciones y sistemas de UI. Creé una experiencia inmersiva para que los usuarios aprendan y practiquen diversas tareas.",
        "project-3-feature-1": "Tutoriales VR interactivos",
        "project-3-feature-2": "Animaciones personalizadas y elementos UI",
        "project-3-feature-3": "Diseño de interfaz amigable",
        "project-3-feature-4": "Optimizado para rendimiento en VR",
        "project-3-tech": "<strong>Tecnologías:</strong> Unity, C#, Desarrollo VR",
        "project-3-video": "Ver Video de Demo",
        "project-4-title": "Lanzador de Juegos para PC",
        "project-4-desc": "Renové la interfaz del lanzador para...",
        "project-4-modal-title": "Lanzador de Juegos para PC (Visionary Tool)",
        "project-4-modal-desc": "Renové la interfaz de usuario de un lanzador de juegos para PC, mejorando su accesibilidad y experiencia de usuario general. Me enfoqué en crear un diseño moderno y visualmente atractivo con navegación clara.",
        "project-4-feature-1": "Diseño UI modernizado",
        "project-4-feature-2": "Navegación y diseño mejorados",
        "project-4-feature-3": "Características de accesibilidad mejoradas",
        "project-4-feature-4": "Optimización de la experiencia del usuario",
        "project-4-tech": "<strong>Tecnologías:</strong> Unity, C#, Diseño UI/UX",
        "project-4-screenshots": "Ver Capturas de Pantalla",
        "project-5-title": "Sistema de Guardado de Juego Móvil",
        "project-5-desc": "Implementé Firebase para datos seguros...",
        "project-5-modal-title": "Sistema de Guardado de Juego Móvil (FunTech Rocket)",
        "project-5-modal-desc": "Implementé un sistema de guardado robusto para un juego móvil usando Firebase. Esto aseguró la persistencia de datos segura y permitió a los usuarios guardar su progreso en múltiples dispositivos.",
        "project-5-feature-1": "Integración de Firebase para persistencia de datos",
        "project-5-feature-2": "Almacenamiento y recuperación de datos seguros",
        "project-5-feature-3": "Sincronización entre dispositivos",
        "project-5-feature-4": "Manejo de errores y validación de datos",
        "project-5-tech": "<strong>Tecnologías:</strong> Unity, C#, Firebase Realtime Database",
        "project-5-play": "Jugar (Enlace a App Store)",
